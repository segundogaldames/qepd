<?php /* Smarty version Smarty-3.1.21-dev, created on 2015-10-28 01:38:02
         compiled from "/Applications/MAMP/htdocs/mercadomuebles/views/empresas/add.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20171289355ccaa3785a874-53686258%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b8d2077676f1154d85325d6e484fb26710912f29' => 
    array (
      0 => '/Applications/MAMP/htdocs/mercadomuebles/views/empresas/add.tpl',
      1 => 1445992677,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20171289355ccaa3785a874-53686258',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_55ccaa37b2df82_22166781',
  'variables' => 
  array (
    'dias' => 0,
    'd' => 0,
...
<?php if ($_valid && !is_callable('content_55ccaa37b2df82_22166781')) {function content_55ccaa37b2df82_22166781($_smarty_tpl) {?><div class="col-md-2"></div>
...
<div class="col-md-8">
	...
	<form action="" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
		...
		<div class="form-group">
			<div class="col-md-3">
				<label for="email" class="pull-right">Correo electrónico <span class="text-danger">*</span>:</label>
			</div>
			<div class="col-md-6">
				<input type="text" name="email" class="form-control" placeholder="Correo electrónico de contacto">
			</div>
		</div>
		<div class="form-group">
			<div class="col-md-3">
